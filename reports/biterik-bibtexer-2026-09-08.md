...
_Updated 2026-09-08T08:05:33Z (UTC) · machine-readable: [VITALS.json](VITALS.json) · full history: [history.ndjson](history.ndjson) · daily snapshots: [snapshots/](snapshots/)_

| | |
|---|---|
| Repository created | 2026-01-15 |
| Tracked by repo-vitals since | 2026-06-24 (77 days)³ |
...
Everything recorded so far, from 2026-06-24 (77 days) — the total, and the same total expressed as an average rate.

| Metric | Total | Average / 30 d |
|---|---:|---:|
| Views | 7 | 2.7 |
| Unique visitors¹ | 4 | 1.6 |
| Clones | 332 | 129.4 |
| Unique cloners¹ | 257 | 100.1 |
| Stars gained | 1 | 0.4 |
| Release downloads gained | 3 | 1.2 |
...
**Conversion funnel (30 d):** 3 unique visitors → 118 unique cloners → 0 stars gained → 3 downloads gained
...
[reports/biterik-BibTexer-2026-09-08.md](reports/biterik-BibTexer-2026-09-08.md)
