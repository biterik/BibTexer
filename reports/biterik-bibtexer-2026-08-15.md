...
_Updated 2026-08-15T03:54:28Z (UTC) · machine-readable: [VITALS.json](VITALS.json) · full history: [history.ndjson](history.ndjson) · daily snapshots: [snapshots/](snapshots/)_

| | |
|---|---|
| Repository created | 2026-01-15 |
| Tracked by repo-vitals since | 2026-06-24 (53 days)³ |
...
| Clones | 140 | 191 | 191 |
| Stars gained | 0 | 0 | 1 |
| Release downloads gained | 2 | 2 | 2 |

¹ sum of daily unique counts — an upper bound on true period uniques.

## Since tracking began

Everything recorded so far, from 2026-06-24 (53 days) — the total, and the same total expressed as an average rate.

| Metric | Total | Average / 30 d |
|---|---:|---:|
| Views | 1 | 0.6 |
| Unique visitors¹ | 1 | 0.6 |
| Clones | 191 | 108.1 |
| Unique cloners¹ | 150 | 84.9 |
| Stars gained | 1 | 0.6 |
| Release downloads gained | 2 | 1.1 |
...
**Conversion funnel (30 d):** 0 unique visitors → 108 unique cloners → 0 stars gained → 2 downloads gained
...
[reports/biterik-BibTexer-2026-08-15.md](reports/biterik-BibTexer-2026-08-15.md)
