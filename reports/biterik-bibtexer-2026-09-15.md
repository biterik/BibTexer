...
_Updated 2026-09-15T08:41:19Z (UTC) · machine-readable: [VITALS.json](VITALS.json) · full history: [history.ndjson](history.ndjson) · daily snapshots: [snapshots/](snapshots/)_

| | |
|---|---|
| Repository created | 2026-01-15 |
| Tracked by repo-vitals since | 2026-06-24 (84 days)³ |
...
| Clones | 198 | 397 | 397 |
| Stars gained | 0 | 0 | 1 |
| Release downloads gained | 0 | 3 | 3 |

¹ sum of daily unique counts — an upper bound on true period uniques.

## Since tracking began

Everything recorded so far, from 2026-06-24 (84 days) — the total, and the same total expressed as an average rate.

| Metric | Total | Average / 30 d |
|---|---:|---:|
| Views | 9 | 3.2 |
| Unique visitors¹ | 6 | 2.1 |
| Clones | 397 | 141.8 |
| Unique cloners¹ | 311 | 111.1 |
| Stars gained | 1 | 0.4 |
...
**Conversion funnel (30 d):** 5 unique visitors → 153 unique cloners → 0 stars gained → 0 downloads gained
...
[reports/biterik-BibTexer-2026-09-15.md](reports/biterik-BibTexer-2026-09-15.md)
